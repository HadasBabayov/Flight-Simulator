...
namespace FlightGearApp
{
    public class WheelControllerViewModel : INotifyPropertyChanged
    {
        ...
        public int VM_Time
        {
            get
            {
                return wheelControllerModel.Time;
            }
            set
            {
                wheelControllerModel.Time = value;
            }
        }
        public int VM_Pace
        {
            get
            {
                return wheelControllerModel.Pace;
            }
            set
            {
                wheelControllerModel.Pace = value;
            }
        }
        public bool VM_ShouldStop
        {
            get
            {
                return wheelControllerModel.ShouldStop;
            }
            set
            {
                wheelControllerModel.ShouldStop = value;
            }
        }
